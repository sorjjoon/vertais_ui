...
export type AnswerFragment = (
  { __typename?: 'Answer' }
  & Pick<Answer, 'description' | 'createdAt' | 'updatedAt'>
  & { files: Array<(
    { __typename?: 'FileDetails' }
    & FileFragment
  )>, task: (
...
export type AssignmentFragment = (
  { __typename?: 'Assignment' }
  & Pick<Assignment, 'id' | 'name' | 'description' | 'createdAt' | 'updatedAt' | 'deadline' | 'reveal'>
  & { files: Array<(
    { __typename?: 'FileDetails' }
    & FileFragment
  )>, tasks: Array<(
    ...
    { __typename?: 'AssignmentOptions' }
    & AssignmentOptionsFragment
  ), peerAssesment?: Maybe<(
    { __typename?: 'PeerAssesmentAssignment' }
    & Pick<PeerAssesmentAssignment, 'id'>
    & { pairs?: Maybe<Array<(
      { __typename?: 'PeerAssesmentPair' }
      & Pick<PeerAssesmentPair, 'id' | 'points'>
      & { assessor: (
        { __typename?: 'Account' }
        & Pick<Account, 'id'>
      ) }
      ...
      { __typename?: 'PeerAssesmentOptions' }
      & PeerAssesmentOptionsFragment
    ) }
  )> }
);

export type AssignmentOptionsFragment = (
  { __typename?: 'AssignmentOptions' }
  & Pick<AssignmentOptions, 'deadline' | 'reveal' | 'hasPeerAssesment'>
);

export type CommentFragment = (
  { __typename?: 'Comment' }
  & Pick<Comment, 'id' | 'content' | 'reveal' | 'createdAt' | 'updatedAt'>
  & { course?: Maybe<(
    { __typename?: 'Course' }
    & Pick<Course, 'id'>
  )>, owner: (
...
export type CourseFragment = (
  { __typename?: 'Course' }
  & Pick<Course, 'id' | 'name' | 'description' | 'abbreviation' | 'code' | 'createdAt' | 'updatedAt' | 'icon'>
  & { owner: (
    { __typename?: 'Account' }
    & AccountDetailsFragment
  ), comments: Array<(
...
export type FeedbackFragment = (
  { __typename?: 'Feedback' }
  & Pick<Feedback, 'id' | 'description' | 'createdAt' | 'updatedAt' | 'childIndex'>
  & { grade?: Maybe<(
    { __typename?: 'Grade' }
    & Pick<Grade, 'id' | 'submitId'>
  )>, peerAssesment?: Maybe<(
    { __typename?: 'PeerAssesmentPair' }
    & Pick<PeerAssesmentPair, 'id'>
  )> }
);

export type FileFragment = (
  { __typename?: 'FileDetails' }
  & Pick<FileDetails, 'id' | 'filename' | 'createdAt' | 'updatedAt' | 'mimetype'>
);

export type GradeFragment = (
  { __typename?: 'Grade' }
  & Pick<Grade, 'id' | 'createdAt' | 'updatedAt' | 'points' | 'isRevealed' | 'submitId'>
  & { owner: (
    { __typename?: 'Account' }
    & AccountDetailsFragment
  ), comments: Array<(
...
export type PeerAssesmentAssignmentFragment = (
  { __typename?: 'PeerAssesmentAssignment' }
  & Pick<PeerAssesmentAssignment, 'id' | 'createdAt' | 'updatedAt'>
  & { pairs?: Maybe<Array<(
    { __typename?: 'PeerAssesmentPair' }
    ...
    { __typename?: 'Assignment' }
    & Pick<Assignment, 'id' | 'createdAt' | 'updatedAt' | 'name'>
    & { options: (
      { __typename?: 'AssignmentOptions' }
      & Pick<AssignmentOptions, 'deadline' | 'hasPeerAssesment'>
    ), tasks: Array<(
      { __typename?: 'Task' }
      & Pick<Task, 'id' | 'number' | 'points'>
    )> }
  ) }
);

export type PeerAssesmentOptionsFragment = (
  { __typename?: 'PeerAssesmentOptions' }
  & Pick<PeerAssesmentOptions, 'peerAssesmentCount' | 'revealAutomatically' | 'deadline'>
);

export type PeerAssesmentPairFragment = (
  { __typename?: 'PeerAssesmentPair' }
  & Pick<PeerAssesmentPair, 'id' | 'createdAt' | 'updatedAt' | 'points' | 'description'>
  & { assessor: (
    { __typename?: 'Account' }
    & AccountDetailsFragment
  ), assessedSubmits: Array<(
    { __typename?: 'Submit' }
    & Pick<Submit, 'id' | 'createdAt' | 'updatedAt' | 'description'>
    & { owner: (
      { __typename?: 'Account' }
      & Pick<Account, 'id'>
    ), task: (
...
export type TaskFragment = (
  { __typename?: 'Task' }
  & Pick<Task, 'id' | 'number' | 'createdAt' | 'updatedAt' | 'description' | 'points'>
  & { files: Array<(
    { __typename?: 'FileDetails' }
    & FileFragment
  )>, submits: Array<(
    { __typename?: 'Submit' }
    & Pick<Submit, 'id' | 'updatedAt'>
    & { grade?: Maybe<(
      { __typename?: 'Grade' }
      & Pick<Grade, 'id' | 'updatedAt' | 'points'>
    )>, owner: (
      { __typename?: 'Account' }
      & Pick<Account, 'id'>
    ) }
...
export type UserFragment = (
  { __typename?: 'Account' }
  & Pick<Account, 'username' | 'createdAt' | 'updatedAt' | 'email'>
  & AccountDetailsFragment
);

export type AccountDetailsFragment = (
  { __typename?: 'Account' }
  & Pick<Account, 'id' | 'role' | 'firstName' | 'lastName'>
);

export type AccountResponseFragment = (
  { __typename?: 'AccountResponse' }
  & { errors?: Maybe<Array<(
    { __typename?: 'FieldError' }
    & FieldErrorFragment
...
export type FieldErrorFragment = (
  { __typename?: 'FieldError' }
  & Pick<FieldError, 'message' | 'fieldName'>
);
...
export type InsertAssignmentMutation = (
  { __typename?: 'Mutation' }
  & { insertAssignment: (
    { __typename?: 'Course' }
    & Pick<Course, 'id'>
...
export type UpdatePeerAssesmentMutation = (
  { __typename?: 'Mutation' }
  & { updatePeerAssesment: (
    { __typename?: 'PeerAssesmentPair' }
    & Pick<PeerAssesmentPair, 'id' | 'points' | 'updatedAt' | 'description'>
  ) }
);
...
export type InsertCourseMutation = (
  ...
  & { insertCourse?: Maybe<(
    { __typename?: 'Course' }
    & Pick<Course, 'id' | 'icon' | 'createdAt' | 'updatedAt' | 'description' | 'abbreviation' | 'name'>
  )> }
);
...
export type SignUpCourseMutation = (
  { __typename?: 'Mutation' }
  & { signUpCourse?: Maybe<Array<(
    { __typename?: 'Course' }
    & CourseFragment
  )>> }
);
...
export type DeleteSubmitMutation = (
  { __typename?: 'Mutation' }
  & { deleteSubmit: (
    { __typename?: 'Task' }
    & Pick<Task, 'id'>
...
export type UpdateGradeMutation = (
  ...
  & { updateGrade: (
    ...
    & { grade?: Maybe<(
      { __typename?: 'Grade' }
      & Pick<Grade, 'id' | 'points' | 'isRevealed'>
    )> }
  ) }
);
...
export type UpdateSubmitMutation = (
  { __typename?: 'Mutation' }
  & { updateSubmit: (
    { __typename?: 'Task' }
    & Pick<Task, 'id'>
...
export type GetCourseSubmitDetailsQuery = (
  { __typename?: 'Query' }
  & { getCourse?: Maybe<(
    { __typename?: 'Course' }
    & Pick<Course, 'id'>
    & { assignments: Array<(
      ...
      & { options: (
        ...
        { __typename?: 'Task' }
        & Pick<Task, 'id' | 'points' | 'number'>
        & { mySubmit?: Maybe<(
          { __typename?: 'Submit' }
          & Pick<Submit, 'id' | 'updatedAt'>
          & { grade?: Maybe<(
            { __typename?: 'Grade' }
            & Pick<Grade, 'id' | 'points'>
          )> }
        )> }
      )>, peerAssesment?: Maybe<(
        { __typename?: 'PeerAssesmentAssignment' }
...
export type GetMyPeerAssesmentQuery = (
  { __typename?: 'Query' }
  & { getMyPeerAssesment?: Maybe<(
    { __typename?: 'PeerAssesmentAssignment' }
    & PeerAssesmentAssignmentFragment
  )> }
);
...
export type GetSubmitsQuery = (
  ...
  & { getSubmits: Array<(
    ...
    & { owner: (
      ...
      { __typename?: 'Grade' }
      & Pick<Grade, 'id' | 'createdAt' | 'updatedAt' | 'points' | 'isRevealed'>
      & { owner: (
        { __typename?: 'Account' }
        & AccountDetailsFragment
      ) }
...
export type GetUpcomingAssignmentsQuery = (
  { __typename?: 'Query' }
  & { getUpcomingAssignments: (
    ...
    & { peerAssesments: Array<(
      ...
      & { assignment: (
        ...
        { __typename?: 'PeerAssesmentOptions' }
        & Pick<PeerAssesmentOptions, 'deadline'>
      ) }
    )>, assignments: Array<(
      { __typename: 'Assignment' }
      & Pick<Assignment, 'id' | 'name'>
      & { options: (
        { __typename?: 'AssignmentOptions' }
        & Pick<AssignmentOptions, 'deadline'>
      ) }
    )> }
  ) }
);
...
export const InsertAssignmentDocument = gql`
    mutation InsertAssignment($name: String!, $options: AssignmentOptionsInput!, $peerAssesmentOptions: PeerAssesmentOptionsInput!, $description: String!, $filesToLink: [Int!]!, $filesToDelete: [Int!]!, $tasks: [TaskInfo!]!, $courseId: Int!) {
  insertAssignment(
    tasks: $tasks
...
export const UpdateAssignmentDocument = gql`
    mutation UpdateAssignment($name: String!, $options: AssignmentOptionsInput!, $description: String!, $peerAssesmentOptions: PeerAssesmentOptionsInput!, $filesToLink: [Int!]!, $filesToDelete: [Int!]!, $tasks: [TaskInfo!]!, $id: Int!) {
  updateAssignment(
    tasks: $tasks
    peerAssesmentOptions: $peerAssesmentOptions
    description: $description
...
export function useUpdatePeerAssesmentMutation() {
  return Urql.useMutation<UpdatePeerAssesmentMutation, UpdatePeerAssesmentMutationVariables>(UpdatePeerAssesmentDocument);
};
...
export const UpdateGradeDocument = gql`
  ...
  updateGrade(
    submitId: $submitId
    data: {points: $points, isRevealed: $isRevealed}
  ) {
    id
    grade {
      id
...
export const RegisterDocument = gql`
    mutation Register($isTeacher: Boolean!, $username: String!, $password: String!, $firstName: String!, $lastName: String!, $email: String) {
  register(
...
export function useGetCourseSubmitDetailsQuery(options: Omit<Urql.UseQueryArgs<GetCourseSubmitDetailsQueryVariables>, 'query'> = {}) {
...
export function useGetMyPeerAssesmentQuery(options: Omit<Urql.UseQueryArgs<GetMyPeerAssesmentQueryVariables>, 'query'> = {}) {
...
export function useGetUpcomingAssignmentsQuery(options: Omit<Urql.UseQueryArgs<GetUpcomingAssignmentsQueryVariables>, 'query'> = {}) {
